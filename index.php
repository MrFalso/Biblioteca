    ...
    <div class="login">
        ...
        <form action="controllo.php" method="get">
            <div class="login-obj">
                ...
                <br><br>
                <div class="btn-login">
                    <input type="submit" class="button7" value="Accedi" name="tipo" style="width: 40px; height: 50px;">
    ...
    <div class="container" id="container">
    	<div class="form-container sign-in-container">
            <form action="controllo.php" method="get">
    			...
    			<input type="submit" value="Accedi" name="tipo"/> 
    		</form>
    	</div>
    	<div class="overlay-container">
    		<div class="overlay">
                ...
                <form action="crea_account.php" method="get">
    			    <h1>Registrati</h1>
                    <br><br>
    			    <input type="text" placeholder="Username" name="user" style="width: 250px;"/>
    			    <input type="password" placeholder="Password" name="pass"/>
                    <input type="text" placeholder="Età" name="eta"/>
                    <input type="text" placeholder="Residenza" name="res"/>
